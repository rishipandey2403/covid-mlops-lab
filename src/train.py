...
def make_splits(
    ...
    val_size is relative to the remaining (not overall).
    """
...
def build_baseline_pipeline(cfg: dict) -> Pipeline:
    ...
    # Logistic Regression baseline (robust for sparse one-hot)
...
def main() -> None:
    ...
    # Load data (you can reduce sample_n for quick local iteration)
    ...
    # Evaluate quickly on val (full evaluation + threshold tuning happens in evaluate.py)
